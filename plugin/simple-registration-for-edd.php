<?php
/**
 * Plugin Name: Simple registration for EDD
 ...
 *
 * @package   Simple registration for EDD
 * @author    SkyVerge
 * @category  Admin
...
/**
 * Creates helper functionality for our websites.
 *
 * @since 1.0.0
 */
class Simple_Registration_EDD_Loader {
	...
	const PLUGIN_NAME = 'Simple registration for EDD';

	/** @var Simple_Registration_EDD_Loader single instance of this plugin */
	...
	/**
	 * Simple_Registration_EDD_Loader constructor.
	 *
	 * @since 1.0.0
	 */
	...
	/**
	 * Adds notices for out-of-date WordPress versions.
	 *
	 * @since 1.0.0
	 */
	public function add_plugin_notices() {
		...
		if ( ! $this->is_edd_compatible() ) {
			...
			$this->add_admin_notice( 'update_edd', 'error', sprintf(
				'%s is not active, as it requires Easy Digital Downloads version %s or higher. Please %supdate EDD &raquo;%s',
	...
	/**
	 * Displays any admin notices added with \Simple_Registration_EDD_Loader::add_admin_notice()
	 *
	 * @since 1.0.0
	 */
	...
	/**
	 * Gets the main \Simple_Registration_EDD_Loader instance.
	 *
	 * Ensures only one instance can be loaded.
	 *
	 * @since 1.0.0
	 *
	 * @return \Simple_Registration_EDD_Loader
	 */
...
// fire it up!
Simple_Registration_EDD_Loader::instance();
